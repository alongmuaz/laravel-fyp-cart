            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if($errors->any())
                        ...
                        <div class="form form-small portlet-body">
                            <!-- Register form (not working)-->

                            {!! Form::model(array($form,'url' => 'store/checkoutbaru')) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('pref_bank', ['Maybank'], null, ['class' => 'form-control'])  !!}
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('method', ['Online Banking', 'Cash Deposit', 'GIRO Transfer'], null, ['class' => 'form-control'])  !!}
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
